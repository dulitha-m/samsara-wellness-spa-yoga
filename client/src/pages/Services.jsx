  ...
  return (
    <div className="services-page">
      ...
      <section className="services-header">
        ...
        <ParticleField count={16} color="rgba(197,168,128,0.25)" />
      ...
      <section className="services-cta">
        <div className="container">
          ...
          >
            ...
            <a href="/contact" className="btn-gold">Inquire Now</a>
          </motion.div>
        </div>
      </section>
