  ...
  return (
    <div className="heritage-page">
      <section className="heritage-header">
        ...
        <ParticleField count={14} color="rgba(197,168,128,0.2)" />
      ...
      <section className="heritage-story">
        <div className="container heritage-story__grid">
          ...
          >
            <Tilt3D max={10} scale={1.03} glare>
           ...
           <div className="timeline">
              {[
                ...
                <motion.div
                  ...
                  initial={{ opacity: 0, x: i % 2 === 0 ? -50 : 50, rotateY: i % 2 === 0 ? -12 : 12 }}
                  whileInView={{ opacity: 1, x: 0, rotateY: 0 }}
                  viewport={{ once: true }}
                ...
                >
                  ...
                  <Tilt3D max={8} scale={1.03} className="timeline-content glass">
                    <h3>{item.title}</h3>
                    <p>{item.text}</p>
                  </Tilt3D>
                </motion.div>
